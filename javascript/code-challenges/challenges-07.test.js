...
const removeThree = (idx, arr) => {
  ...
  // let tempArrary = []; 
  // tempArrary = arr.splice(idx,3);
  // return tempArrary;  //why did this fail?

  // console.log(arr, idx);
  // console.log(arr.slice(idx,3));  // why does this return []  
  // console.log(arr.splice(idx,3));  //[ 3, 4, 5 ]
};
...
const joinArray = (arr) => {
  // Solution code here...
  // pretty much copied this straight from the Array and String Methods Overview
  return arr.join(' ');
};
...
const howMuchPencil = (str) => {
  ...
  for (let i = 0; i < str.length; i++) {
    ...
    // result.map(temp);  //nope... map modifies an existing array
  }
